# Copyright (c) 2023, Albert Gu, Tri Dao. https://raw.githubusercontent.com/state-spaces/mamba/main/mamba_ssm/models/mixer_seq_simple.py
...
class MambaLMHeadModel(nn.Module, GenerationMixin):
    ...
    def __init__(
        ...
        **backbone_kwargs,
        ...
        if tie_weights: self.tie_weights()
